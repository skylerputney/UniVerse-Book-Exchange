...
include_once $basePath . '/View/MessageView.php';
include_once $basePath . '/View/MessagesMenuView.php';
class HomeView{
	private $model;
	...
	public function display(){
		...
		<head>
			...
			<link rel="icon" href="../View/Logos/favicon-96x96.png">
			<meta charset="utf-8">
	    ...
	    <div class="jumbotron">
        <div class="container text-center" style="width: 400px; height: 140px;padding: 0px;border-radius: 10px;background-color: rgba(200,200,200,0.2);border: 2px solid violet;position: relative;top: -10px;">
			<img src="../View/Logos/full-logo.png" alt="Small Logo" style="width: 100%; height: 100%;object-fit: cover;border-radius: 10px;">
        </div>
    </div>
        ...
        <div class="container text-center">
            <form method="POST">
                <div class="input-group">
                    ...
                    <input type="hidden" value="getListings" name="action">
...
$html .='<div class="sorting-buttons">
            <form class="sort-form" method="POST">
                <div class="input-group">
                    ...
                    <input type="hidden" value="sortListings" name="action">
						...
						<input class="universityCheck save-cb-state keyboard-clickable" id = "universityCheck" name="sameUniversity" type="checkbox" value="1" autocomplete="off" hidden >
						<label tabindex="0" class="custom-button keyboard-clickable" for="universityCheck">My University</label>
						<script>
		...
		//Grid of Listings
        $listings = $this->model->getCurrentListings();
        ...
        if (!empty($listings)) {
            ...
            foreach ($listings as $listing) {
                ...
                $html .= "<div class=\"panel-heading\" style=\"border-bottom: 2px solid violet;background-color: rgba(200,50,200,0.25);color: violet; font-weight:bold;\">" . $listing['bookName'] . "</div>";
                ...
                $html .= "</div>";
                $html .= "<div class=\"panel-footer\" style=\"border-top: 2px solid violet;background-color: rgba(200,50,200,0.25);color: violet; font-weight:bold;\">$" . $listing['bookPrice'] . "</div>";
                $html .= "</div></div>";
