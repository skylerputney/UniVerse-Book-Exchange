<?php
require_once $basePath . '/View/CreateListingView.php';
require_once $basePath . '/View/ListingView.php';
require_once $basePath . '/View/MessagesMenuView.php';

class YourListingsView{
	private $model;
	...
	public function display(){
        ...
        <div class="container text-center" style="width: 450px;border-radius: 10px;background-color: rgba(200,200,200,0.2);border-color: violet;border: 2px solid violet;">
			<h1 style="color:violet;">' . $seller['username'] . '\'s Listings</h1>;
        ...
        <div class="container text-center">
            <form method="POST">
                <div class="input-group">
                    <input type="hidden" value="yourlistings" name="route">
                    <input type="hidden" value="getYourListings" name="action">
	...
	<div class="sorting-buttons">
		...
		//Grid of Listings
        $listings = $this->model->getYourCurrentListings();
